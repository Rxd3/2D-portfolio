...
export const dialogueData = {
    ...
    "ML-projects": "<strong>Machine learning & research</strong><br>I contribute to research on differential privacy and privacy-adversarial synthetic data generation, evaluating GAN and VAE models with accuracy and FID metrics.<br><br>At Istinye XR Lab, I support pediatric cardiovascular research involving anomaly detection, CT heart-scan segmentation, and aorta centerline extraction.<br><br>I also built an accident-risk prediction model and an interactive route-safety game. <a href='https://raod-quiz.streamlit.app' target='_blank' rel='noopener noreferrer'>Open the live project</a> or <a href='https://github.com/Rxd3/road-safety-quiz' target='_blank' rel='noopener noreferrer'>view the source on GitHub</a>.",
