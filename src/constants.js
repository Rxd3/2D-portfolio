...
export const dialogueData = {
    ...
    websites: "<strong>Web projects</strong><br><strong>Corai:</strong> a full-stack learning platform that turns a syllabus into a complete course and quizzes using the Gemini API and a custom PostgreSQL backend. <a href='https://cor-ai.app' target='_blank' rel='noopener noreferrer'>Visit cor-ai.app</a>.<br><br><strong>NeuroTechTR:</strong> a deployed website for a student-led robotics and AI research team. <a href='https://neurotechtr.com' target='_blank' rel='noopener noreferrer'>Visit neurotechtr.com</a>.",

    "ML-projects": "<strong>Machine learning & research</strong><br>I contribute to research on differential privacy and privacy-adversarial synthetic data generation, evaluating GAN and VAE models with accuracy and FID metrics.<br><br>At Istinye XR Lab, I support pediatric cardiovascular research involving anomaly detection, CT heart-scan segmentation, and aorta centerline extraction.<br><br>I also built an accident-risk prediction model and an interactive route-safety game. <a href='https://raod-quiz.streamlit.app' target='_blank' rel='noopener noreferrer'>Open the project</a>.",
    ...
    bed: "<strong>Interests</strong><br>Outside individual projects, I enjoy software development, robotics, AI applications, automation, and 3D modeling—especially work that connects software with real-world systems.",
